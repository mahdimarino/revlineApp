        ...
        <div class="row align-center">
            <div class="col-lg-4 left-info">
                <div  class="thumb text-center">
                    <img class="smallerinmobile" src="assets/img/scott.jpeg"
                        alt="Thumb">
                    <div class="social">
                        <ul>

                            <li>
                                <a style="background-image: url(assets/img/linkdinlogoimg.png);     background-size: 100%;"
                                  target="_blank"  href="https://www.linkedin.com/in/scott-campbell-13b92635/">
            ...
            <div class="col-lg-8 right-info">
                ...
                <ul>
                    <li>
                        <strong>Email:</strong>
                        <a href="mailto:scott@revlinemarketing.com">scott@revlinemarketing.com</a>
                    </li>
                    <li>
                        <strong>Phone:</strong>
        ...
        <div class="main-services-box">
            <div class="row">
                ...
                <div class="col-12 mb-5 text-center">
                    <img width="150px" src="assets/img/ios.png" alt="">
                </div>
